...
if(!function_exists('cl')){
    ...
    {
        $script = '<script>';
        $script .= 'console.log("输出调试数据-----------------------------");';
        $script .= 'console.log(`'.print_r($data,true).'`);';
        $script .= 'console.log("输出调试数据完毕-------------------------");';
        $script .= '</script>';
        echo $script;
    }
}
if(!function_exists('is_login')) {
     ...
     */
    function is_login() {
        return \app\common\library\Auth::instance()->isLogin();
    }
}
